...
#define DIAG_CURR_Pin GPIO_PIN_3
#define DIAG_CURR_GPIO_Port GPIOA
#define DIAG_TEMP_0_Pin GPIO_PIN_4
#define DIAG_TEMP_0_GPIO_Port GPIOA
#define DIAG_TEMP_1_Pin GPIO_PIN_5
#define DIAG_TEMP_1_GPIO_Port GPIOA
#define DIAG_TEMP_2_Pin GPIO_PIN_6
#define DIAG_TEMP_2_GPIO_Port GPIOA
