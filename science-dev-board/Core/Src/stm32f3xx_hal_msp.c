...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOC, DIAG_TEMP_0_Pin|DIAG_TEMP_1_Pin|DIAG_TEMP_2_Pin);

    HAL_GPIO_DeInit(GPIOA, DIAG_CURR_0_Pin|DIAG_CURR_1_Pin|DIAG_CURR_2_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA6     ------> ADC2_IN3
    */
    HAL_GPIO_DeInit(GPIOA, SCIENCE_TEMP_0_Pin|SCIENCE_TEMP_1_Pin|SCIENCE_TEMP_2_Pin);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PF1-OSC_OUT     ------> I2C2_SCL
    */
    HAL_GPIO_DeInit(I2C2_SPECTRAL_SDA_GPIO_Port, I2C2_SPECTRAL_SDA_Pin);

    HAL_GPIO_DeInit(I2C2_SPECTRAL_SCL_GPIO_Port, I2C2_SPECTRAL_SCL_Pin);
