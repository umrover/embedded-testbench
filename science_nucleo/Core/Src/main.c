...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, DEBUG_LED_0_Pin|DEBUG_LED_1_Pin|DEBUG_LED_2_Pin|DEBUG_LED_3_Pin
                          |MOSFET_0_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, MOSFET_1_Pin|MOSFET_2_Pin|MOSFET_3_Pin|MOSFET_4_Pin
                          |MOSFET_5_Pin|MOSFET_6_Pin|MOSFET_7_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, MOSFET_8_Pin|MOSFET_9_Pin|MOSFET_10_Pin|MOSFET_11_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DEBUG_LED_0_Pin DEBUG_LED_1_Pin DEBUG_LED_2_Pin DEBUG_LED_3_Pin
                           MOSFET_0_Pin */
  GPIO_InitStruct.Pin = DEBUG_LED_0_Pin|DEBUG_LED_1_Pin|DEBUG_LED_2_Pin|DEBUG_LED_3_Pin
                          |MOSFET_0_Pin;
  ...
  /*Configure GPIO pins : MOSFET_1_Pin MOSFET_2_Pin MOSFET_3_Pin MOSFET_4_Pin
                           MOSFET_5_Pin MOSFET_6_Pin MOSFET_7_Pin */
  GPIO_InitStruct.Pin = MOSFET_1_Pin|MOSFET_2_Pin|MOSFET_3_Pin|MOSFET_4_Pin
                          |MOSFET_5_Pin|MOSFET_6_Pin|MOSFET_7_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : MOSFET_8_Pin MOSFET_9_Pin MOSFET_10_Pin MOSFET_11_Pin */
  GPIO_InitStruct.Pin = MOSFET_8_Pin|MOSFET_9_Pin|MOSFET_10_Pin|MOSFET_11_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
