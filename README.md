...
![Pinout](https://i.imgur.com/vlJXqHF.png)
...
## Common errors
### Optimization
G050 project changes so that it fits in FLASH
Go to Project -> properties
Under C/C++ Build -> Settings
Under MCU GCC Compiler -> Optimization
Choose optimization level "Optimize more (-O2)

## TODO
 - [ ] Update Thermistor description
 - [ ] Update Spectral description
 - [ ] Update Mosfet description
 - [ ] Create Servo description
 - [ ] Create Spectral Triad description
