...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    GPIO_InitStruct.Pin = I2C2_BACKUP_SCL_Pin|I2C2_BACKUP_SDA_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* hi2c)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(I2C2_BACKUP_SCL_GPIO_Port, I2C2_BACKUP_SCL_Pin);

    HAL_GPIO_DeInit(I2C2_BACKUP_SDA_GPIO_Port, I2C2_BACKUP_SDA_Pin);
...
void HAL_TIM_Encoder_MspDeInit(TIM_HandleTypeDef* htim_encoder)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PE11     ------> TIM1_CH2
    */
    HAL_GPIO_DeInit(GPIOE, QUAD_A_0_Pin|QUAD_B_0_Pin);
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    HAL_GPIO_DeInit(GPIOA, QUAD_A_1_Pin|QUAD_B_1_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA7     ------> TIM3_CH2
    */
    HAL_GPIO_DeInit(GPIOA, QUAD_A_2_Pin|QUAD_B_2_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB7     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOB, USART2_TX_Pin|USART1_RX_Pin);
